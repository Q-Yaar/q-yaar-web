...
export default function GameDetail() {
  ...
  // Fetch Team Data
  const { data: team, isLoading: isTeamLoading, error: teamError } = useFetchMyTeamQuery(gameId!);
  ...
  const gameInfo = {
    ...
    image: "https://images.unsplash.com/photo-1556103255-4443dbae8e5a?w=400&h=300&fit=crop",
    players: "3-6",
    duration: "3-4 hours",
    category: "RPG",
  };
